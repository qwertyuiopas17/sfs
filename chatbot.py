...
@app.route("/v1/debug-doctor/<doctor_id>")
def debug_doctor(doctor_id):
    """Temporary endpoint to debug doctor data"""
    try:
        doctor = Doctor.query.filter_by(doctor_id=doctor_id.upper()).first()
        if doctor:
            return jsonify({
                ...
                "has_password_hash": doctor.password_hash is not None,
