...
CORS(app, supports_credentials=True, resources={
    r"/v1/*": {
        "origins": [
            ...
            "https://saharasaathi.netlify.app"], # IMPORTANT: Add your deployed frontend's URL here later
...
def register():
    try:
        ...
        full_name = data.get("fullName", "").strip() # Changed variable name for clarity
       ...
       # --- START OF FIX ---
        ...
        # Auto-generate patient ID (for internal use only)
        ...
        new_user = User(
            ...
            email=email,
            full_name=full_name,  # Save to the correct 'full_name' field
        ...
        return jsonify({
            "success": True,
            "message": f"Welcome {full_name}! Your account has been created. You can now log in with your full name."
        }), 201
...
def login():
    try:
        ...
        # The key from the frontend is 'patientId', but its value can be an email or an ID.
       ...
       # --- START OF FIX ---
        ...
        # Query by full_name or email for flexibility
